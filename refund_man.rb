...
count.times do
    ...
    oorders = get_ogoods_orders_within stime, etime #can be improved by add search conditions
    day = day.prev_day
end
...
oorders.each do |order|
    ...
    point_inc += award_points

    if balance_inc > 0 || point_inc > 0
