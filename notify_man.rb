...
def get_delivery_info order
    ...
    case line
    when '[X]'
        info += "已整单取消，感谢信任！任何问题请联系丰巢小蜜18998382701，微信同号"
        ship = '已取消订单'
    when '[T]'
        info += "已收到，我们将按该团的【交付时间】，为您安排配送或产地直发。"
        info += "感谢信任！任何问题请联系丰巢小蜜18998382701，微信同号"
        ship = '团购订单'
    when '[Z]'
        ...
        info += "已收到，我们将于【#{esat[:est]}】为您进行发货，预计【#{esat[:eat]}】送达，"
        info += "感谢信任！任何问题请联系丰巢小蜜18998382701，微信同号"
        ship = esat[:ship]
    end
