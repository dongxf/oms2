/*
 ...
 Source Host           : rdsagent.foodtrust.cn:1402
 Source Schema         : crmeb
...
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
CREATE TABLE `eb_store_product` (
  ...
  `pospal_code` varchar(36) DEFAULT '' COMMENT '银豹系统商品编码，只用于迁移数据',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 COMMENT='附件管理表';
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='附件分类表';
...
INSERT INTO `eb_system_config` VALUES (49, 'store_brokerage_ratio', 'text', 'input', 9, '', 0, 'required:true,min:0,max:100,number:true', 100, 0, '\"3\"', '一级返佣比例', '订单交易成功后给上级返佣的比例0 - 100,例:5 = 反订单金额的5%', 5, 1);
...
INSERT INTO `eb_system_config` VALUES (87, 'store_brokerage_two', 'text', 'input', 9, '', 0, 'required:true,min:0,max:100,number:true', 100, 0, '\"2\"', '二级返佣比例', '订单交易成功后给上级返佣的比例0 - 100,例:5 = 反订单金额的5%', 4, 1);
...
CREATE TABLE `eb_system_config_tab` (
  ...
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='配置分类表';
...
CREATE TABLE `eb_system_file` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2187 DEFAULT CHARSET=utf8 COMMENT='文件对比表';
...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='组合数据表';
...
CREATE TABLE `eb_system_group_data` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=utf8 COMMENT='组合数据详情表';
...
CREATE TABLE `eb_system_log` (
  ...
  KEY `add_time` (`add_time`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='管理员操作记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=497 DEFAULT CHARSET=utf8 COMMENT='菜单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='门店自提';
...
CREATE TABLE `eb_system_user_level` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='设置用户等级表';
...
CREATE TABLE `eb_system_user_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='等级任务设置';
...
CREATE TABLE `eb_template_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='微信模板';
...
CREATE TABLE `eb_user` (
  ...
  `pospal_number` varchar(36) DEFAULT '' COMMENT '银豹系统商品代码，只用于迁移数据',
